...
public:
  ...
  GBool setFreeTypeHinting(char *s);
...
private:
  ...
  void addDisplayFont(GHash* fonts, DisplayFontParam *param);
  ...
  GBool freeTypeHinting;	// FreeType hinting enable flag
