...
static struct {
  ...
  {"Courier",               "psfonts/n022003l.pfb", NULL},
  {"Courier-Bold",          "psfonts/n022004l.pfb", NULL},
  {"Courier-BoldOblique",   "psfonts/n022024l.pfb", NULL},
  {"Courier-Oblique",       "psfonts/n022023l.pfb", NULL},
  {"Helvetica",             "psfonts/n019003l.pfb", NULL},
  {"Helvetica-Bold",        "psfonts/n019004l.pfb", NULL},
  {"Helvetica-BoldOblique", "psfonts/n019024l.pfb", NULL},
  {"Helvetica-Oblique",     "psfonts/n019023l.pfb", NULL},
  {"Symbol",                "psfonts/s050000l.pfb", NULL},
  {"Times-Bold",            "psfonts/n021004l.pfb", NULL},
  {"Times-BoldItalic",      "psfonts/n021024l.pfb", NULL},
  {"Times-Italic",          "psfonts/n021023l.pfb", NULL},
  {"Times-Roman",           "psfonts/n021003l.pfb", NULL},
  {"ZapfDingbats",          "psfonts/d050000l.pfb", NULL},
  {NULL}
#else
...
#if defined(__BEOS__) || defined(__HAIKU__)
	if (dir && fileName == NULL && displayFontTab[i].ttFileName) {
      fileName = appendToPath(new GString(dir), displayFontTab[i].ttFileName);
      kind = displayFontTT;
...
GBool GlobalParams::getFreeTypeHinting() {
  GBool f;
...
GBool GlobalParams::setFreeTypeHinting(char *s) {
  GBool ok;

  lockGlobalParams;
  ok = parseYesNo2(s, &freeTypeHinting);
  unlockGlobalParams;
  return ok;
}
